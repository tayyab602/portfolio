    ...
    >
      ...
      <div className="container px-6 mx-auto grid lg:grid-cols-[1fr_auto] items-end pt-20">
        ...
        <div className="flex flex-col justify-center gap-5 pb-20 lg:pb-28 z-10 self-center">
          ...
          {/* Salam — big greeting like reference "Hello," */}
          <motion.p
          ...
          <motion.h1
            ...
            transition={{ duration: 0.85, ease: APPLE_EASE, delay: 0.18 }}
            className="font-black tracking-tight leading-none"
          ...
          <motion.p
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: APPLE_EASE, delay: 0.32 }}
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.75, ease: APPLE_EASE, delay: 0.45 }}
        ...
        <motion.div
          ...
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 1.1, delay: 0.22, ease: APPLE_EASE }}
