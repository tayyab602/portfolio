...
const projects = [
  {
    ...
    description:
      "A fully operational e-commerce venture run primarily through WhatsApp. Handled product sourcing, customer relations, order fulfillment, and marketing. A real-world lesson in customer behavior and business operations.",
  ...
  },
  {
    ...
    description:
      "Built a custom dashboard to track inventory levels for the beauty store, replacing manual spreadsheets. Integrates sales data and provides low-stock alerts.",
  ...
  },
  {
    ...
    type: "Tool",
    description:
      "A Python script that securely authenticates with the university portal, scrapes new result postings, and sends automated notifications to students.",
        ...
        >
          {projects.map((project) => (
            <motion.div
              ...
              className={`group relative flex flex-col justify-between p-8 rounded-2xl bg-card border ${project.border} overflow-hidden cursor-default`}
            >
              <div
